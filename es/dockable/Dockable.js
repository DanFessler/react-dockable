...
var Dockable = /*#__PURE__*/function (_Component) {
  ...
  function Dockable() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleWindowClosed", function (panelId, windowId) {
      var newPanels = JSON.parse(JSON.stringify(_this.getPanels()));
  ...
  _proto.componentDidMount = function componentDidMount() {
    if (this.props.initialState) {
      ...
      var newPanels = [{
        ...
        windows: [{
          selected: 0,
          widgets: React.Children.map(this.props.children, function (widget) {
            return {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "Dockable_root " + css.container + " " + (this.props.themeClass ? this.props.themeClass : css.theme),
      ...
      return /*#__PURE__*/React.createElement(WindowPanel, {
        key: panelIndex,
        index: panelIndex,
    ...
    }))), this.state.contextMenu && this.state.contextMenu.show && /*#__PURE__*/React.createElement(ContextMenu, {
