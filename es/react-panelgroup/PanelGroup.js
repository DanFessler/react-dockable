...
var PanelGroup = /*#__PURE__*/function (_React$Component) {
  ...
  function PanelGroup(props) {
    ...
    if (!_this.isControlled(props)) {
      _this.state.panels = props.panelWidths ? _this.applyDefaults(props.panelWidths) : React.Children.map(_this.props.children, function (child) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      i + 1 < React.Children.count(_this3.props.children) && /*#__PURE__*/React.createElement(Divider, {
